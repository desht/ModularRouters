...
public class CompiledVacuumModule extends CompiledModule {
    ...
    private static final int XP_PER_BOTTLE = 7;  // average xp per bottle o' enchanting
    ...
    private boolean handleItemMode(TileEntityItemRouter router) {
        ...
        for (EntityItem item : items) {
            ...
            if ((bufferStack == null || ItemHandlerHelper.canItemStacksStack(stackOnGround, bufferStack)) && getFilter().test(stackOnGround)) {
    ...
    private boolean handleXpMode(TileEntityItemRouter router) {
        ...
        if (inRouterStack == null || inRouterStack.getItem() == Items.EXPERIENCE_BOTTLE && inRouterStack.stackSize < inRouterStack.getMaxStackSize()) {
            ...
            spaceForXp = inRouterStack == null ?
                    64 * XP_PER_BOTTLE : (inRouterStack.getMaxStackSize() - inRouterStack.stackSize) * XP_PER_BOTTLE;
            ...
            switch (xpMethod) {
                case BOTTLES:
                    ...
                    if (xpBuffered > XP_PER_BOTTLE) {
                        ...
                        xpBuffered -= bottleStack.stackSize * XP_PER_BOTTLE;
                        if (excess != null) {
