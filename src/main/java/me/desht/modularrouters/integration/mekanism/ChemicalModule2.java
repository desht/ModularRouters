...
public class ChemicalModule2 extends ChemicalModule1 implements IRangedModule, IPositionProvider, ITargetedModule {
    private static final TintColor TINT_COLOR = new TintColor(220, 150, 255);
