...
public abstract class ModuleItem extends MRBaseItem implements ModItems.ITintable {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
        ...
        if (ClientUtil.getHoveredSlot() instanceof RouterMenu.InstalledModuleSlot && !ClientUtil.isKeyDown(ModularRoutersClient.keybindModuleInfo)) {
            Component key = ModularRoutersClient.keybindConfigure.getKey().getDisplayName().copy().withStyle(ChatFormatting.DARK_AQUA);
